...
public class Utils 
{
    ...
    /// <summary>
    /// Calcula a velocidade necessária para um projeto atingir um alvo
    /// </summary>
    /// <param name="from">Ponto de partida</param>
    /// <param name="to">Alvo a atingir</param>
    /// <param name="angle">Ângulo de inclinação</param>
    /// <returns></returns>
